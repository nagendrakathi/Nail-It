          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="w-full flex flex-col justify-start mt-12 ms:mt-0">
              ...
              <button
                ...
                className="w-1/4 bg-blackkbg-blackbg-black text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-yellow-100 hover:text-black border border-yellow-50 hover:border-yellow-300 transition-colors cursor-pointer"
                onClick={handleCTA}
              >
                Get Started    </button>
            </div>
